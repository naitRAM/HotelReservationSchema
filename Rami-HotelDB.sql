...
CREATE TABLE Reservation (
    ...
    CONSTRAINT FOREIGN KEY fk_Reservation_Guest (GuestId)
...
CREATE TABLE Room (
    ...
    CONSTRAINT FOREIGN KEY fk_Room_RoomType (RoomTypeId)
...
CREATE TABLE ReservationRoom (
    ...
    CONSTRAINT FOREIGN KEY fk_ReservationRoom_Reservation (ReservationId)
		REFERENCES Reservation(ReservationId),
	CONSTRAINT FOREIGN KEY fk_ReservationRoom_Room (RoomId)
...
CREATE TABLE RoomAmenity (
    ...
    CONSTRAINT FOREIGN KEY fk_RoomAmenity_Room (RoomId)
		REFERENCES Room(RoomId),
	CONSTRAINT FOREIGN KEY fk_RoomAmenity_Amenity (AmenityId)
